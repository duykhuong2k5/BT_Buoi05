...
public class EmailUtil {
    ...
    public static void sendResetPasswordEmail(String toEmail, String token) {
        ...
        final String username = "handuykhuong05012005@gmail.com"; // Thay bằng email của bạn
        final String appPassword = "hnyqzihkuolardrh"; // Thay bằng mật khẩu ứng dụng của bạn
